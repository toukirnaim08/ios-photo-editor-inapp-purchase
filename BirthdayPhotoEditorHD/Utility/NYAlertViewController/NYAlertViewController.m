...
- (void)viewDidLoad {
    ...
    //backgroundImage.frame = CGRectMake(0 , 0, self.view.frame.width, self.view.frame.height * 0.2);
    
    //float width = uiscreen
    //let height = UIScreen.mainScreen().bounds.size.height
    backgroundImage.frame = CGRectMake(0,0,[[UIScreen mainScreen] bounds].size.width,
...
- (void)setAlertViewBackgroundColor:(UIColor *)alertViewBackgroundColor {
    ...
    self.view.alertBackgroundView.alpha = 0.8;
...
- (void)addAction:(UIAlertAction *)action {
   // [action setValue:[UIImage imageNamed:@"Down.png"] forKey:@"image"];
